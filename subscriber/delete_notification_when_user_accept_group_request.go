...
func DeleteNotificationWhenUserAcceptGroupRequest(appCtx appcontext.AppContext, ctx context.Context) {
	ch := appCtx.PubSub().Subscribe(ctx, common.TopicAcceptGroupRequest)
